...
##MAIN##
inputfile = '/data/project/hostbot/bot/data/teahouse_questions_revs20140223.csv'
outputfile = '/data/project/hostbot/bot/data/teahouse_questions_text20140223.csv'
