...
#                 'output section title' : '== {{subst:PAGENAME}}, you are invited to the Teahouse ==',
                'inviters' : ['Rosiestep', 'Missvain', 'Naypta', 'AmaryllisGardener', 'Doctree', 'I JethroBT', 'Keelan', 'Cordless Larry', 'Gestrid', 'Cullen328', 'Lectonar', '78.26', 'Worm That Turned', 'ChamithN', 'Nick Moyes', 'John from Idegon', 'GreenMeansGo', 'Abelmoschus Esculentus', 'Masumrezarock100', 'MrClog'],
            ...
            'test_invites' : { #when using the test db th_invite_test
                ...
                'edit summary' : ', you are invited to the Teahouse!',
#                 'output section title' : '== {{subst:PAGENAME}}, you are invited to the Teahouse ==',
                'inviters' : ['Rosiestep','Jtmorgan','Missvain','Liz','Naypta','AmaryllisGardener','Doctree','I JethroBT', 'Keelan', 'Cordless Larry', 'Gestrid', 'Cullen328', 'Lectonar', 'Mz7', '78.26', 'Worm That Turned', 'ChamithN', 'Samwalton9',],
                'inviter edit threshold' : 21,
                'conditions' : ['th-invite', 'control'],
