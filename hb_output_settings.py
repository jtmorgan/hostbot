...
#                 'output section title' : '== {{subst:PAGENAME}}, you are invited to the Teahouse ==',
                'inviters' : ['Rosiestep', 'Missvain', 'Naypta', 'AmaryllisGardener', 'Doctree', 'I JethroBT', 'Dathus', 'Cordless Larry', 'Gestrid', 'Cullen328', 'Lectonar', 'Mz7', '78.26', 'Worm That Turned', 'ChamithN', 'Nick Moyes', 'John from Idegon', 'GreenMeansGo', 'Abelmoschus Esculentus', 'Masumrezarock100', 'RhinosF1'],
