		...
		self.output_params = {
		  'teahouse_gallery' : {
			...
			'th invites' : {
				...
				'inviters' : ['Rosiestep','Jtmorgan','Missvain','AmaryllisGardener','Doctree','Osarius','Soni','Technical 13', 'I JethroBT', 'Dathus', '78.26', 'Worm That Turned', 'ChamithN', 'Lightbreather',],
