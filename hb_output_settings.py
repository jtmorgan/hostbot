...
#                 'output section title' : '== {{subst:PAGENAME}}, you are invited to the Teahouse ==',
                'inviters' : ['Missvain', 'Naypta', 'AmaryllisGardener', 'Doctree', 'I JethroBT', 'Keelan', 'Cordless Larry', 'Cullen328', 'Lectonar', '78.26', 'Worm That Turned', 'ChamithN', 'Nick Moyes', 'GreenMeansGo', 'MrClog', 'Jtmorgan', 'Bop34', 'GoingBatty', 'TheAafi'],
